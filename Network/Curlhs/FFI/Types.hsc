...
newtype CCURLoption_I      = CCURLoption_I      CInt deriving (Eq, Show)
newtype CCURLoption_P      = CCURLoption_P      CInt deriving (Eq, Show)
newtype CCURLoption_F      = CCURLoption_F      CInt deriving (Eq, Show)
newtype CCURLoption_O      = CCURLoption_O      CInt deriving (Eq, Show)
