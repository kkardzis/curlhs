...
newtype CCURLoption_I32    = CCURLoption_I32    CInt deriving (Eq, Show)
newtype CCURLoption_I64    = CCURLoption_I64    CInt deriving (Eq, Show)
newtype CCURLoption_String = CCURLoption_String CInt deriving (Eq, Show)
newtype CCURLoption_SList  = CCURLoption_SList  CInt deriving (Eq, Show)
newtype CCURLoption_HTTPP  = CCURLoption_HTTPP  CInt deriving (Eq, Show)
newtype CCURLoption_File   = CCURLoption_File   CInt deriving (Eq, Show)
newtype CCURLoption_Share  = CCURLoption_Share  CInt deriving (Eq, Show)
newtype CCURLoption_Ptr_a  = CCURLoption_Ptr_a  CInt deriving (Eq, Show)
newtype CCURLoption_FunPtr = CCURLoption_FunPtr CInt deriving (Eq, Show)
...
newtype CCURLinfo_S        = CCURLinfo_S        CInt deriving (Eq, Show)
newtype CCURLinfo_I        = CCURLinfo_I        CInt deriving (Eq, Show)
newtype CCURLinfo_D        = CCURLinfo_D        CInt deriving (Eq, Show)
newtype CCURLinfo_L        = CCURLinfo_L        CInt deriving (Eq, Show)
